...
<head>
    ...
    <link rel="stylesheet" href="Horario de grupo.css">
...
<body>
    <div class="wrapper">
        <header>
            <h1 class="title">SISTEMA INTEGRAL DE SERVICIOS ACADÉMICOS <br> <center>(DOCENTES)</center> </h1>
            <a href="../Docente.php" class="In">Inicio</a>
