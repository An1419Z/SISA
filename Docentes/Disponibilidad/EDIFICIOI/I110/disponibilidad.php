...
$sql = "SELECT Horario, Lunes, Martes, Miercoles, Jueves, Viernes FROM I110";
$result = $enlace->query($sql);

// Consulta SQL para obtener las agendas ACEPTADAS o PENDIENTES
$sqlAgendacion = "SELECT Horario, Estado FROM Agendacion 
                  WHERE Salon = 'I110' AND (Estado = 'ACEPTADO' OR Estado = 'PENDIENTE')"; 
