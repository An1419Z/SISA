...
$sql = "SELECT Horario, Lunes, Martes, Miercoles, Jueves, Viernes FROM AudI";
$result = $enlace->query($sql);

// Consulta SQL para obtener las agendas ACEPTADAS o PENDIENTES
$sqlAgendacion = "SELECT Horario, Estado FROM Agendacion 
                  WHERE Salon = 'Audivisual I' OR 'AUDIOVISUAL I' AND (Estado = 'ACEPTADO' OR Estado = 'PENDIENTE')"; 
...
if ($result->num_rows > 0) {
 ...
 #000;
    ...
    echo '<h1 align="center">AUDIOVISUAL I</h1>'; 
